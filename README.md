...
| IsoButane              | a      | b       |
| ---------------------- | ------ | ------- |
| ratio > 0.821          | 1.0725 | -0.0786 |
| 0.658 < ratio <= 0.821 | 1.5342 | -0.1838 |
| 0.514 < ratio <= 0.658 | 1.8529 | -0.2248 |
| 0.351 < ratio <= 0.514 | 3.1315 | -0.3168 |
...
| 0.428 < ratio <= 0.658 | 2.2176 | -0.3572 |
| 0.274 < ratio <= 0.428 | 2.7757 | -0.406  |
...
| Ethanol                | a      | b       |
| ---------------------- | ------ | ------- |
| ratio > 0.554          | 1.6105 | -0.3138 |
| 0.303 < ratio <= 0.554 | 3.0468 | -0.5012 |
| 0.148 < ratio <= 0.303 | 6.1074 | -0.6522 |
| 0.067 < ratio <= 0.148 | 6.3217 | -0.6583 |
...
| 0.237 < ratio <= 0.444 | 2.6156 | -0.5214 |
| 0.139 < ratio <= 0.237 | 2.2189 | -0.4857 |
